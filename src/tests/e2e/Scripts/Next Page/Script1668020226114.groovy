...
WebUI.verifyElementVisible(findTestObject('Page_IW React Tech Test/td_La Sainte Union Convent School'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_IW React Tech Test/td_ THE ARGENTINIAN'), FailureHandling.STOP_ON_FAILURE)
